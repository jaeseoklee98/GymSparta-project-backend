...
@RequestMapping("/api/orders/{ordersId}/reviews")
public class ReviewController {
     ...
     * 리뷰 생성
     *
     * @param ordersId 매장 ID. 매장을 이용한 사용자만 리뷰를 작성할 수 있습니다.
    ...
    public ResponseEntity<CommonResponse<ReviewResponse>> createReview(
        ...
        ReviewResponse reviewResponse = reviewService.createReview(reviewRequest, ordersId, userDetails);
     ...
     * 리뷰 조회
     *
     * @param ordersId 주문 ID. 조회할 리뷰가 속한 매장의 고유 식별자입니다.
    ...
    public ResponseEntity<CommonResponse<List<ReviewResponse>>> getReviews(
        ...
        List<ReviewResponse> reviewResponseList = reviewService.getReviewsByOrder(ordersId, userDetails);
     ...
     */
    @PutMapping("/{reviewId}")
    public ResponseEntity<CommonResponse<ReviewResponse>> updateReview(@PathVariable Long reviewId, @RequestBody ReviewRequest reviewRequest, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        ReviewResponse reviewResponse = reviewService.updateReview(reviewId, reviewRequest, userDetails);
        CommonResponse<ReviewResponse> response = new CommonResponse<>(
    ...
    public ResponseEntity<CommonResponse<ReviewResponse>> deleteReview(@AuthenticationPrincipal UserDetailsImpl userDetails,  @PathVariable Long reviewId) {
        ReviewResponse reviewResponse = reviewService.deleteReview(reviewId, userDetails);
        CommonResponse<ReviewResponse> response = new CommonResponse<>(
                HttpStatus.OK.value(), "리뷰 삭제 완료", reviewResponse);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
